...
public class ActivityProviderController {
	...
	public String providerSubmit(Model model, @ModelAttribute ActivityProviderData providerData) {
		logger.info("brokerSubmit name:{}, code:{}", providerData.getName(), providerData.getCode());
		try {
			ActivityInterface.createProvider(providerData);
				...
				model.addAttribute("brokers", ActivityInterface.getProviders());
				return "providers";
			}
