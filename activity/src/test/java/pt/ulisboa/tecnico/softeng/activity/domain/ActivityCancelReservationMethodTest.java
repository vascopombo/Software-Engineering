...
public class ActivityCancelReservationMethodTest {
	...
	public void success() {
		...
		String cancel = this.provider.cancelReservation(reference);
		data = this.provider.getActivityReservationData(reference);
		
		Assert.assertEquals(data.getCancellation(), cancel);
